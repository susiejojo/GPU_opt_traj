...
ax.scatter(x_1[0,0], y_1[0,0],s=13**2,color = "red", marker ="x") 
ax.scatter(x_1[1,0], y_1[1,0],s=13**2,color = "pink", marker ="x") 

ax.scatter3D(x_1[0,-1], y_1[0,-1], s=8**2, color = "red") 
ax.scatter3D(x_1[1,-1], y_1[1,-1], s=8**2, color = "pink") 
...
plt.savefig("results/2_agents_"+str(rad)+".jpg")
plt.show()
