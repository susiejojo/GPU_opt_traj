...
def inv_matrix_generator(nbot,Pddot,Qx,Qy,Qz,Aeq_x,Aeq_y,Aeq_z,Afc,rho):
    for i in range(len(rho)):
        ...
        savemat('matrices/cost_mat_inv_x'+str(i)+'.mat', {'inv_x': inv_x})
        ...
        savemat('matrices/cost_mat_inv_y'+str(i)+'.mat', {'inv_y': inv_y})
        ...
        savemat('matrices/cost_mat_inv_z'+str(i)+'.mat', {'inv_z': inv_z})

        savemat('matrices/Aeq_x.mat', {'Aeq_x': Aeq_x})
        savemat('matrices/Aeq_y.mat', {'Aeq_y': Aeq_y})
        savemat('matrices/Aeq_z.mat', {'Aeq_z': Aeq_z})

        savemat('matrices/Afc.mat', {'Afc': Afc})

    savemat('matrices/rho.mat', {'rho_init': rho})
