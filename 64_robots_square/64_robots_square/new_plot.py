...
paths = os.getcwd()+"/drive/MyDrive/64_robots_square/"

rad = sys.argv[1]


#####################robots trajectories ###########################
x_temp = scipy.io.loadmat(paths+'x_1.mat')
x_1 = x_temp['x_1'].squeeze()

y_temp = scipy.io.loadmat(paths+'y_1.mat')
y_1 = y_temp['y_1'].squeeze()

z_temp = scipy.io.loadmat(paths+'z_1.mat')
...
cmaps = {64:["red","pink","orange","green","grey","navy","yellow","purple","darkgreen","teal","salmon","black","cyan","brown","coral","lime",
...
for t in range(100):
  ...
  for j in range(64):
      ...
      #     (x_all[i,t], y_all[i,t]),radius = a_obs/2,
      #     facecolor= cmaps[n_agents][i],
      #     fill = True)
      # ax.add_patch(srec)
      ax.scatter3D(x_1[j,t],y_1[j,t],z_1[j,t],s=0.5**2,color=cmaps[64][j])
      ax.plot(x_1[j,:t],y_1[j,:t],z_1[j,:t],cmaps[64][j],linewidth = 0.2)
  ...
  plt.savefig(paths+"data/"+filename,dpi=200)
  plt.cla()
  plt.close(figure)
...
plt.savefig(paths+"64_agents_"+str(rad)+".jpg")
plt.show()
