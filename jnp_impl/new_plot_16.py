...
ax.plot(x_1[8,:-1],y_1[8,:-1],z_1[8,:-1], color ='darkgreen', linewidth = 3.0)
ax.plot(x_1[9,:-1],y_1[9,:-1],z_1[9,:-1], color ='teal', linewidth = 3.0)
ax.plot(x_1[10,:-1],y_1[10,:-1],z_1[10,:-1], color ='salmon', linewidth = 3.0)
ax.plot(x_1[11,:-1],y_1[11,:-1],z_1[11,:-1], color ='black', linewidth = 3.0)
ax.plot(x_1[12,:-1],y_1[12,:-1],z_1[12,:-1], color ='cyan', linewidth = 3.0)
ax.plot(x_1[13,:-1],y_1[13,:-1],z_1[13,:-1], color ='brown', linewidth = 3.0)
ax.plot(x_1[14,:-1],y_1[14,:-1],z_1[14,:-1], color ='coral', linewidth = 3.0)
ax.plot(x_1[15,:-1],y_1[15,:-1],z_1[15,:-1], color ='lime', linewidth = 3.0)
...
plt.savefig(paths+"results/16_agents_"+str(rad)+".jpg")
plt.show()
