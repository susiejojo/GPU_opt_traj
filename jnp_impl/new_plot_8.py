...
ax.plot(x_1[4,:-1],y_1[4,:-1],z_1[4,:-1], color ='grey', linewidth = 3.0)
ax.plot(x_1[5,:-1],y_1[5,:-1],z_1[5,:-1], color ='navy', linewidth = 3.0)
ax.plot(x_1[6,:-1],y_1[6,:-1],z_1[6,:-1], color ='yellow', linewidth = 3.0)
ax.plot(x_1[7,:-1],y_1[7,:-1],z_1[7,:-1], color ='purple', linewidth = 3.0)
...
plt.savefig(paths+"results/8_agents_"+str(rad)+".jpg")
plt.show()
